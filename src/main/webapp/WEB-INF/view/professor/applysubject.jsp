			...
			<div class="col-md-10 p-5">
				<form action="/professor/apply" method="post" class="form--container" onsubmit="return validateForm()">
					<div class="card">
						<div class="card-body">
							<div class="mb-3">
								<label for="subName" class="form-label">강의명</label> <input
									type="text" class="form-control" id="subName" name="subName"
									placeholder="강의명을 입력하세요">
							</div>
							<div class="mb-3">
								<label for="proName" class="form-label">교수이름</label> <input
									type="text" class="form-control" id="proName" name="proName"
									placeholder="교수이름을 입력하세요">
							</div>
							<div class="mb-3">
							...
							<div class="mb-3">
								<label for="subGrade" class="form-label">학점</label> <input
									type="text" class="form-control" id="subGrade" name="subGrade"
