													...
													<c:forEach var="thisSemesterGrade"
														...
														<c:if test="${not empty thisSemesterGrade.grade}">
															<tr>
																...
																<td><c:choose>
																		<c:when
																			test="${not empty thisSemesterGrade.evaluationId}"> ${thisSemesterGrade.grade} </c:when>
																		<c:otherwise> - </c:otherwise>
																	</c:choose></td>
																<td><c:choose>
																		<c:when
																			test="${not empty thisSemesterGrade.evaluationId}"> - </c:when>
																		<c:otherwise> ${thisSemesterGrade.evaluationId} 
																			<a
