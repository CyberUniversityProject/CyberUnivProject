						...
						<div class="card-body">
							<div class="mb-3">
								<label for="name" class="form-label">강의명</label> <input
									...
									placeholder="강의명을 입력하세요" autocomplete="off" value="${subjectInfo.name}">
							</div>
								...
								<div>
									<div class="form-check form-check-inline">
										<input class="form-check-input" type="radio" name="type"
											id="major" value="전공"
											<c:if test="${subjectInfo.type == '전공'}">checked</c:if>>
										<label class="form-check-label" for="major">전공</label>
									</div>
									<div class="form-check form-check-inline">
										<input class="form-check-input" type="radio" name="type"
											id="culture" value="교양"
											<c:if test="${subjectInfo.type == '교양'}">checked</c:if>>
								...
								<div>
									<div class="form-check form-check-inline">
										<input class="form-check-input" type="radio" name="semester"
											id="1학기" value="1"
											<c:if test="${subjectInfo.semester == 1}">checked</c:if>>
										<label class="form-check-label" for="1학기">1학기</label>
									</div>
									<div class="form-check form-check-inline">
										<input class="form-check-input" type="radio" name="semester"
											id="2학기" value="2"
											<c:if test="${subjectInfo.semester == 2}">checked</c:if>>
								...
								<div>
									<div class="form-check form-check-inline">
										<input class="form-check-input" type="radio" name="subDay"
											id="mo" value="월"
											<c:if test="${subjectInfo.subDay == '월'}">checked</c:if>>
										<label class="form-check-label" for="mo">월</label>
									</div>
									<div class="form-check form-check-inline">
										<input class="form-check-input" type="radio" name="subDay"
											id="tu" value="화"
											<c:if test="${subjectInfo.subDay == '화'}">checked</c:if>>
										<label class="form-check-label" for="tu">화</label>
									</div>
									<div class="form-check form-check-inline">
										<input class="form-check-input" type="radio" name="subDay"
											id="we" value="수"
											<c:if test="${subjectInfo.subDay == '수'}">checked</c:if>>
										<label class="form-check-label" for="we">수</label>
									</div>
									<div class="form-check form-check-inline">
										<input class="form-check-input" type="radio" name="subDay"
											id="th" value="목"
											<c:if test="${subjectInfo.subDay == '목'}">checked</c:if>>
										<label class="form-check-label" for="th">목</label>
									</div>
									<div class="form-check form-check-inline">
										<input class="form-check-input" type="radio" name="subDay"
											id="fr" value="금"
											<c:if test="${subjectInfo.subDay == '금'}">checked</c:if>>
