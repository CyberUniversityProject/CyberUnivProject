...
/**
 *
 * @FileName : PageResponseDto.java
 * @Project : CyberUniversity
 * @Date : 2024. 3. 16.
 * @작성자 : 김수현
 * @변경이력 :
 * @프로그램 설명 : 페이지네이션, 페이지 응답 Dto
 */
...
@NoArgsConstructor
@AllArgsConstructor
public class PageResponseDto<Object> {
    ...
    public PageResponseDto(List<Object> content, int number, long totalElements, int size) {
